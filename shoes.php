<?php 
    ...
    {
        $shoes = "SELECT * FROM products where itemType = 'Shoes';";
        $products = $db->query($shoes);
        return $products;
    }
    if(empty($_SESSION)) {
...
<body>
            ...
            <!--Drop Down Menu-->
                <li class  = "dropdown">
                    ...
                    <ul class = "dropdown-menu" role="menu">
                        ...
                        <li><a href="sportequipments.php" id = "text2"> Sport Equipments </a></li>
                    </ul>
                </li>
    ...
    <h2 class = "text-center" id="text2"><b>Category: Shoes</b></h2>
