<?php 
    ...
    {
        $sports = "SELECT * FROM products where itemType = 'Sport Equipments';";
        $products = $db->query($sports);
        return $products;
    }
    if(empty($_SESSION)) {
        session_unset();
...
<body>
    ...
    <br>
    <div id = "headerPic">
        <h1>We've got the best options</h1>
    </div>
    <h2 class = "text-center" id="text2"><b>Category: Sport Equipments</b></h2>
        ...
        <div class = "col-md-8">
            <div class = "row">
                ...
                <div class = "col-md-3">
                    ...
                    <?php 
                    if($product['list_price'] != '0') { ?>
                        <p class = "list-price text-danger">list_price: <s><?=" $ " . $listPrice;?></s></p>
                    <?php } ?>
                            ...
                            <div class = "container-fluid">
                                <div class = "row">
                                    ...
                                    <div class = "col-sm-6">
                                        ...
                                        <form action = "sportsequipments.php" method = "post">
